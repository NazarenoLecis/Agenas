...
EXPECTED_OUTPUT_PAIRS = [
    ...
    "outputs/tables/openbdap_health_expenditure_resources",
    "outputs/tables/istat_demography_links",
    "outputs/tables/siope_links",
    "outputs/tables/health_expenditure_registry",
